...
pulitzer <- mutate(pulitzer, diffrence.in.2004.2013 = Daily.Circulation..2013 - Daily.Circulation..2004)

# What publication gained the most pulitzer prizes from 2004-2014?
# Be sure to use the pipe operator! 
greatest <- pulitzer %>%  filter(Pulitzer.Prize.Winners.and.Finalists..2004.2014 == max(Pulitzer.Prize.Winners.and.Finalists..2004.2014)) %>% select(Newspaper)
